@props(['donation' => null, 'mode' => 'create', 'objectives' => null, 'currencies' => null])
                ...
                @if ($objectives)
                    @foreach ($objectives as $objective)
                        <option value="{{ $objective->id }}"
                            {{ isset($donation['objective']) && $donation['objective'] == $objective->id ? 'selected' : '' }}>
                            {{ $objective->title }}
                        </option>
                    @endforeach
                @endif
                ...
                @if ($currencies)
                    @foreach ($currencies as $currency)
                        <option value="{{ $currency->id }}"
                            {{ isset($donation['currency']) && $donation['currency'] == $currency->id ? 'selected' : '' }}>
